...
// pub async fn remove_google_integration_admin_controller(
...
//     let usecase = RemoveGoogleIntegrationUseCase { user };
...
// pub async fn remove_google_integration_controller(
//     http_req: HttpRequest,
//     body: web::Json<RequestBody>,
//     ctx: web::Data<NettuContext>,
// ) -> Result<HttpResponse, NettuError> {
...
// #[derive(Debug)]
// pub struct RemoveGoogleIntegrationUseCase {
//     pub user: User,
// }
...
// impl UseCase for RemoveGoogleIntegrationUseCase {
