use super::usecases::{create_account::create_account_controller, get_account::get_account_controller};
...
pub fn configure_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.route("/account/pubkey", web::put().to(set_account_pub_key_controller));
}
