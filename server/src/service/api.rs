use super::usecases::{add_user_to_service::add_user_to_service_controller, get_service_bookingslots::get_service_bookingslots_controller};
...
pub fn configure_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.route("/service/{service_id}", web::get().to(get_service_controller));
    cfg.route(
